			...
			<section className={styles.leftcolumn}>
				<div className={styles.game}>
					<div className={styles.description}>
						...
						<p id="descriptionButtonStartStop" className={styles.descriptionP}>Rozpocznij grę:</p>
					</div>
					<div className={styles.control}>
						<select id="picture" className={styles.picture} name="picture" onChange={Game.changePicture}>
						  <option value="" defaultValue>(Wybierz obrazek)</option>
						  <option value="kotek">Kotek</option>
						  <option value="piesek">Piesek</option>
						  <option value="konik">Konik</option>
						</select>
						<select id="dificulty" className={styles.dificulty} name="dificulty">
						...
						<button id="startButton" className={styles.startButton} onClick={Game.startGame}>Start!</button>
					</div>
